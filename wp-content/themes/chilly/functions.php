	...
	$wp_customize->add_section( 'slider_section' , array(
		...
		*/
		...
		?>
		 ...
		 <P><?php esc_html_e('More options available for slider section in SpicePress Pro','chilly');?></P>
		 </div>
		  <div class="pro-box">
		 <a href="<?php echo esc_url('https://helpdoc.spicethemes.com/spicepress/how-to-setup-slider-in-spicepress-theme/');?>" class="read-more-button" id="review_pro" target="_blank"><?php esc_html_e( 'Read More','chilly' ); ?></a>
		 <div>
		<?php
		}
	    }
